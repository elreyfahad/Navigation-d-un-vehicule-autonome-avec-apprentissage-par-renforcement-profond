...
from dqn.tf_util import function,huber_loss
#from dqn.utils import ObservationInput
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        _act = function(inputs=[observations_ph, stochastic_ph, update_eps_ph],
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        _act = function(inputs=[observations_ph, stochastic_ph, update_eps_ph, reset_ph, update_param_noise_threshold_ph, update_param_noise_scale_ph],
                         outputs=output_actions,
                         givens={update_eps_ph: -1.0, stochastic_ph: True, reset_ph: False, update_param_noise_threshold_ph: False, update_param_noise_scale_ph: False},
                         updates=updates)
        
        
        #act(np.array(obs), update_eps=update_eps, **kwargs)[0]
...
`       See the top of the file for details.
    ...
    with tf.variable_scope(scope, reuse=reuse):
        ...
        # q scores for actions which we know were selected in the given state. we create a mask
        ...
        q_values = function([obs_t_input], q_t)
